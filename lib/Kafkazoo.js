 ...
 */
Kafkazoo.prototype.getConsumers = function (topic, consumerGroup, onReady, config) {
    ...
    async.waterfall([
        ...
        function createConsumers(optionsArray, asyncReady) {
            ...
            async.each(optionsArray, function (options, asyncConsumerReady) {
                ...
                var consumer = new Consumer(_.extend(config, {
...
Kafkazoo.prototype.interactWithZookeeper = function (relativePath, onConnected, onReady) {
    ...
    var that = this;
    var zookeeper = new Zookeeper(this.config.zkConfig);
